...
2. `Bash(cp "${CLAUDE_PLUGIN_ROOT}"/starters/design_canvas.jsx artifacts/<dir-of-html>/)` — copy next to the HTML file, spelling the directory out literally (no `$(dirname …)`)
3. Shell:
   ```html
