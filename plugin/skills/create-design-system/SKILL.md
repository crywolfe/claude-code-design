...
allowed-tools: Read Write Edit Glob Grep Bash(cp "${CLAUDE_PLUGIN_ROOT}"/starters/:*) Bash(cp artifacts/:*) Bash(mkdir -p artifacts:*) Bash(ls design-systems:*) Bash(mkdir -p design-systems/:*) Bash(cp artifacts/design-system.html design-systems/:*) Bash(cp .claude/design-tokens.json design-systems/:*) Bash(open file://:*) Bash(open http://127.0.0.1:*) Bash(xdg-open file://:*) Bash(xdg-open http://127.0.0.1:*) mcp__chrome-devtools__navigate_page mcp__chrome-devtools__take_screenshot mcp__chrome-devtools__take_snapshot mcp__chrome-devtools__list_console_messages
---
